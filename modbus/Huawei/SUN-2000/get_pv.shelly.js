...
function buildVirtualComponentsManifest() {
  ...
  for (i = 0; i < SUN2000_PV.length; i++) {
    ...
    components.push({
      ...
      id: nextId,
      config: {
        name: SUN2000_PV[i].name,
        default_value: 0,
        unit: SUN2000_PV[i].units,
        persisted: false,
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Huawei SUN2000 PV', components: groupMembers }
    ]
  };
}
