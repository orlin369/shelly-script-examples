 ...
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/modbus/Growatt/MIC_2500TL-X/growatt_input_entities.shelly.js
 */
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Growatt MIC_2500TL-X Input', components: groupMembers }
    ]
  };
}
