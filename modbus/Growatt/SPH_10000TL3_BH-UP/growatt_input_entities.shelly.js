 ...
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/modbus/Growatt/SPH_10000TL3_BH-UP/growatt_input_entities.shelly.js
 */
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Growatt SPH_10000TL3_BH-UP Input', components: groupMembers }
    ]
  };
}
