 ...
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/modbus/Growatt/SPH_10000TL3_BH-UP/growatt_battery_entities.shelly.js
 */
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Growatt SPH_10000TL3_BH-UP Battery', components: groupMembers }
    ]
  };
}
