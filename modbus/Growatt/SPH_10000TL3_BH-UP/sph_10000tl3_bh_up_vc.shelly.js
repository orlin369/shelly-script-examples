/**
 * @title Growatt SPH 10000TL3 BH-UP MODBUS-RTU monitor + Virtual Components
 * @description Reads the full Growatt SPH 10000TL3 BH-UP register set (PV, output,
...
/**
 * Growatt SPH 10000TL3 BH-UP MODBUS-RTU Monitor + Virtual Components
 *
 ...
 * External hardware: Growatt SPH 10000TL3 BH-UP grid-tie inverter with battery
 * block over RS485. Register map uses input registers throughout.
 *
 * Virtual Components created (9 + 1 group = 10 total):
 * - group:200   Growatt SPH 10000TL3 BH-UP
 * - number:200  Status
...
// Full Growatt SPH 10000TL3 BH-UP register catalog (input registers throughout).
var ENTITIES = [
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Growatt SPH 10000TL3 BH-UP', components: groupMembers }
    ]
  };
}
...
function main() {
  print('Growatt SPH 10000TL3 BH-UP MODBUS-RTU monitor + VC');
