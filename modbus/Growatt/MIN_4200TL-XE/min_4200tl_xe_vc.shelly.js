/**
 * @title Growatt MIN 4200TL-XE MODBUS-RTU monitor + Virtual Components
 * @description Reads the full Growatt MIN 4200TL-XE register set (PV, output,
...
/**
 * Growatt MIN 4200TL-XE MODBUS-RTU Monitor + Virtual Components
 *
...
// Full Growatt MIN 4200TL-XE register catalog (input registers throughout).
var ENTITIES = [
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Growatt MIN 4200TL-XE', components: groupMembers }
    ]
  };
}
...
function main() {
  print('Growatt MIN 4200TL-XE MODBUS-RTU monitor + VC');
