 ...
 * - Modbus slave ID: dynamic, backed by a persisted Virtual Component (see getSlaveId())
...
var VIRTUAL_COMPONENTS = {
  ...
  groups: [
    { id: 299, name: 'Modbus Entity Structure Template Slave ID', components: ['slaveId'] }
  ]
};
