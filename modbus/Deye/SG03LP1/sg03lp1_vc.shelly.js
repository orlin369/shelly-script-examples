/**
 * @title Deye SG03LP1 MODBUS-RTU monitor + Virtual Components
 * @description Reads the full Deye SG03LP1 register set (PV, grid, inverter)
 ...
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/modbus/Deye/SG03LP1/sg03lp1_vc.shelly.js
 */

/**
 * Deye SG03LP1 MODBUS-RTU Monitor + Virtual Components
 *
...
// Full Deye SG03LP1 register catalog (PV, grid, inverter - no battery/BMS).
var ENTITIES = [
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Deye SG03LP1', components: groupMembers }
    ]
  };
}
...
function main() {
  print('Deye SG03LP1 MODBUS-RTU monitor + VC');
