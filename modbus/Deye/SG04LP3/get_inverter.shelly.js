 ...
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/modbus/Deye/SG04LP3/get_inverter.shelly.js
 */

// Deye SG03LP1 – Inverter (AC Output, Currents, Temps) – MODBUS entities
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Deye SG04LP3 Inverter', components: groupMembers }
    ]
  };
}
