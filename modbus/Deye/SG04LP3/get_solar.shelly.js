 ...
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/modbus/Deye/SG04LP3/get_solar.shelly.js
 */

// Deye SG03LP1 – Solar (PV & Production) – MODBUS entities
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Deye SG04LP3 Solar', components: groupMembers }
    ]
  };
}
