 ...
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/modbus/Deye/SG04LP3/get_grid.shelly.js
 */

// Deye SG03LP1 – Grid / CT / Energy – MODBUS entities
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'Deye SG04LP3 Grid', components: groupMembers }
    ]
  };
}
