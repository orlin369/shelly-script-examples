 ...
 * @link https://github.com/ALLTERCO/shelly-script-examples/blob/main/modbus/CyberPower/CP1600EPFCLCD/get_status.shelly.js
 */
...
function buildVirtualComponentsManifest() {
  ...
  return {
    ...
    groups: [
      { id: 200, name: 'CyberPower Status', components: groupMembers }
    ]
  };
}
