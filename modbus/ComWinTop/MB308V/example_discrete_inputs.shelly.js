...
let ENTRY_DI = MODBUS_ENDPOINT.addEntity({ addr: 0, rtype: ModbusController.REGTYPE_DISCRETEINPUT, itype: "i16" });
...
var VIRTUAL_COMPONENTS = {
  ...
  groups: [
    { id: 200, name: 'ComWinTop CWT-MB308V DI0 Example', components: ['di0'] }
  ]
};
