...
/*
    ...
    - Add it to group named ComWinTop CWT-MB308V AI0 Example.
...
function rebuildModbusEndpoint() {
  ...
  ENTRY_AI0 = MODBUS_ENDPOINT.addEntity({ addr: 0, rtype: ModbusController.REGTYPE_INPUT, itype: "i16" });
}
...
var VIRTUAL_COMPONENTS = {
  ...
  groups: [
    { id: 200, name: 'ComWinTop CWT-MB308V AI0 Example', components: ['ai0', 'slaveId'] }
  ]
};
