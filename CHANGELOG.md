...
## 2026-04
- Add `the_pill/Paradox/prt3_ascii_bridge.shelly.js`, an under-development UART bridge for Paradox PRT3 ASCII alarm integrations with optional Virtual Components and a local HTTP command endpoint
